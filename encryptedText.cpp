...
bool isFound(string basicString) {
    for (int i = 0; i < textSize; ++i) {
        if (basicString[i] == 'i' && basicString[i + 1] == 'n'
        && basicString[i + 2] == 't' && basicString[i + 3] == 'r'
        && basicString[i + 4] == 'o' && basicString[i + 5] == 'd'
        && basicString[i + 6] == 'u' && basicString[i + 7] == 'c'
        && basicString[i + 8] == 't' && basicString[i + 9] == 'i'
        && basicString[i + 10] == 'o' && basicString[i + 11] == 'n') {
            return true;
        }
    }
    return false;
        ...
        for (char j = 'a'; j <= 'z'; ++j) {
            for (char k = 'a'; k <= 'z'; ++k) {
                ...
                for (int l = 0; l < textSize; ++l) {
                    char decodedLetter = (char) (encrypted[l] ^ key[l % 3]);
                    if(isValid(decodedLetter)) {
                        decodedText += decodedLetter;
                    }
                }
                if(isFound(decodedText)) {
